...
export const symbols: SymbolEntry[] = [
	...
	// 幾何・証明記号
	{
		symbol: '∟',
		name: '直角記号',
		keywords: ['ちょっかく', '直角', 'かく', '角', 'きかがく', '幾何']
	},
	...
	{ symbol: '∵', name: 'なぜなら', keywords: ['なぜなら', 'ぜったい', '理由', 'りゆう'] },
	{
		symbol: '⊿',
		name: '直角三角形',
		keywords: ['ちょっかくさんかくけい', '直角三角形', 'さんかく', '三角']
	},
	...
	{ symbol: '⊂', name: '部分集合', keywords: ['ぶぶんしゅうごう', '部分集合'] },
	{
		symbol: '⊆',
		name: '部分集合（等号付き）',
		keywords: ['ぶぶんしゅうごう', '部分集合', 'ふくむ', 'いこーる']
	},
	{ symbol: '⊃', name: '含む', keywords: ['ふくむ', '含む'] },
	{
		symbol: '⊇',
		name: '上位集合（等号付き）',
		keywords: ['じょういしゅうごう', 'ふくむ', 'いこーる']
	},
	...
	// 丸数字（箇条書き・注番号）
	{
		symbol: '①',
		name: '丸数字の1',
		keywords: ['まるいち', 'まるすうじ', '丸数字', 'かじょうがき', '箇条書き', 'じゅんばん']
	},
	{
		symbol: '②',
		name: '丸数字の2',
		keywords: ['まるに', 'まるすうじ', '丸数字', 'かじょうがき', '箇条書き']
	},
	{
		symbol: '③',
		name: '丸数字の3',
		keywords: ['まるさん', 'まるすうじ', '丸数字', 'かじょうがき', '箇条書き']
	},
	{
		symbol: '④',
		name: '丸数字の4',
		keywords: ['まるよん', 'まるすうじ', '丸数字', 'かじょうがき']
	},
	{ symbol: '⑤', name: '丸数字の5', keywords: ['まるご', 'まるすうじ', '丸数字', 'かじょうがき'] },
	{
		symbol: '⑥',
		name: '丸数字の6',
		keywords: ['まるろく', 'まるすうじ', '丸数字', 'かじょうがき']
	},
	{
		symbol: '⑦',
		name: '丸数字の7',
		keywords: ['まるなな', 'まるすうじ', '丸数字', 'かじょうがき']
	},
	{
		symbol: '⑧',
		name: '丸数字の8',
		keywords: ['まるはち', 'まるすうじ', '丸数字', 'かじょうがき']
	},
	{
		symbol: '⑨',
		name: '丸数字の9',
		keywords: ['まるきゅう', 'まるすうじ', '丸数字', 'かじょうがき']
	},
	{
		symbol: '⑩',
		name: '丸数字の10',
		keywords: ['まるじゅう', 'まるすうじ', '丸数字', 'かじょうがき']
	},
	...
	{ symbol: '‰', name: 'パーミル', keywords: ['ぱーみる', 'パーミル'] },
	{
		symbol: '㎏',
		name: 'キログラム（単位記号）',
		keywords: ['きろぐらむ', 'キログラム', 'たんい', '単位']
	},
	{
		symbol: '㎝',
		name: 'センチメートル（単位記号）',
		keywords: ['せんち', 'センチ', 'せんちめーとる', 'たんい', '単位']
	},
	{
		symbol: '㎞',
		name: 'キロメートル（単位記号）',
		keywords: ['きろ', 'キロ', 'きろめーとる', 'たんい', '単位']
	},
	{
		symbol: '㎡',
		name: '平方メートル（単位記号）',
		keywords: ['へいほうめーとる', '平方メートル', 'たんい', '単位']
	},
	{
		symbol: '㎢',
		name: '平方キロメートル（単位記号）',
		keywords: ['へいほうきろ', '平方キロ', 'たんい', '単位']
	},
